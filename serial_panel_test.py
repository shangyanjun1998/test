...
class MyWindow(QtWidgets.QMainWindow,Ui_MainWindow):
    ...
    def send_test(self):
        ...
        # send = "01050001FF000000" # 2 on
        # send = "01050002FF000000" # 3 on
        # send = "01050003FF000000" # 4 on

        # send = "0105000000008C3A" # 1 off
        # send = "0105000100000000" # 2 off
        # send = "0105000200000000" # 3 off
        # send = "0105000300000000" # 4 off
        ...
        send = "010F0000000801FF0000" # 1-8on
